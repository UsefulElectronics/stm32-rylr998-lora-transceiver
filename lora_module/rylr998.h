...
#define RYLR998_ReadPirSensorPackRxFlag()		hLoRaModule.rylr998Flag.bit.B3
#define RYLR998_WritePirSensorPackRxFlag(state)	hLoRaModule.rylr998Flag.bit.B3 = state
